...
module.exports = {
  '看地圖|找地點|在哪|在哪裡': function(respons_message) {
  ...
  '看訊息範本': function(respons_message) {
  ...
  '一般型範本|清單範本|按鈕範本|開放社交關係圖範本|媒體範本|收據範本|航空公司登機證範本|航空公司報到範本|航空公司行程範本|航空公司更新範本': function(respons_message) {
    let template = {
      "type": "template"
    };
  ...
  '網址按鈕|回傳按鈕|分享按鈕|購買按鈕|通話按鈕|登入按鈕|登出按鈕|玩遊戲按鈕': function(respons_message) {
    let template = {
      "type": "template"
    };
    respons_message["attachment"] = template;
